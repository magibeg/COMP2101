...
Router Address: $(ip route list default|awk '{print $3}')
Network name  : $(getent networks | grep $(ip route list | grep $(ip a s ens33|grep 'inet '|awk '{print $2}'|sed 's,/.*,,') | awk '{print $1}' | sed 's/...$//') | awk '{print $1}')
