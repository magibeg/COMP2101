...
echo "========silly text lines that start with I========"
grep -w -e '^I' <<< "$somesillytext"
echo "=========================="

echo "========silly text lines that don't end with .========"
grep -e '[^.*]$' <<< "$somesillytext"
echo "=========================="

echo "========silly text lines that are blank or only contain spaces========"
grep -w -e '^$' <<< "$somesillytext"
echo "=========================="
...
echo "========turns lower case into upper case========"
tr -s '[:lower:]' '[:upper:]' <<< "$somesillytext"
echo "=========================="
